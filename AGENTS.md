...
| Develop chat UI           | Build chat page and components       | React, Next.js           | pages/chat.tsx, components/ChatWidget.tsx    | 🔄 In Progress | References `/shells/prototype/` for components and layout patterns    |
